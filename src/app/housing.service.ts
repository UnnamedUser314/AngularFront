...
export class HousingService {
  ...
  private apiUrl = 'https://localhost:7777/api/Design'; 
  ...
  getEntities(): Observable<Designs[]> {
    return this.http.get<Designs[]>(this.apiUrl);
  }

  getEntity(id: number): Observable<Designs> {
    return this.http.get<Designs>(`${this.apiUrl}/${id}`);
  }

  createEntity(entity: Designs): Observable<Designs> {
    return this.http.post<Designs>(this.apiUrl, entity);
  }
